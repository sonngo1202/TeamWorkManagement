...
public class NotificationScheduler {
    ...
    public void notifyUpcomingTasks() {
        for(Task task : taskService.getByEndDate(LocalDate.now())){
            String title ="[Pandoras] Notification: Task Deadline - " + task.getName();
    ...
    private String createHtmlToEmail(Task task) {
        ...
        return "<html>\n" +
                "  <body>\n" +
                "    <h2 style=\"color: #4CAF50;\">Task Deadline Notification</h2>\n" +
                "    <p>Dear User,</p>\n" +
                "    <p>We would like to inform you that a task you are following will expire by the end of today.</p>\n" +
                "\n" +
                ...
                "    </ul>\n" +
                "\n" +
                "    <p style=\"color: red; font-weight: bold;\">This task is nearing its expiration and requires your attention.</p>\n" +
                "\n" +
